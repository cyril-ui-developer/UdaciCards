    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                <TextInput value={question} onChangeText={text => this.setState({question: text})} autoFocus={true} style={[Styles.inputText, styles.stretched]} />
                <Text style={styles.label}>Answer</Text>
                <TextInput value={answer} onChangeText={text => this.setState({answer: text})} style={[Styles.inputText, styles.stretched]} />
